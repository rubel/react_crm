                ...
                <Form>
                  <div>
                    ...
                    <div className="form-outline" style={{ float: "left", marginRight: "6px", width: "27%" }}>
                      ...
                      <Field type="date" name="end_date" placeholder="Date" className="form-control form-control-lg" />
                    </div>
                ...
                <div style={{ width: "100%", height: "570px" }}>
                  <div className="add-user-form">
                    <div className="details-legend2">
                      <p style={{ padding: "5px 12px 0px 0px" }}>{type == "all" ? "User Details" : "Agent Details"}</p>
                    </div>
                    {/*................title......................*/}
                    ...
                    <div className="form-outline">
                      ...
                      <Field type="text" name="phone" placeholder="User Id" className="form-control form-control-lg" />
                    </div>
                  ...
                  <div className="add-user-perm">
                    ...
                    <div style={{ width: "100%", float: "right", marginTop: "27px" }}>
                      ...
                      <button style={{ width: "47%", float: "right" }} className="btn btn-primary btn-lg" type="submit">
                        Submit
                      </button>
                    </div>
                  </div>
              ...
              allUsers.map((user, index) => (
                <tr key={index}>
                  <td>
                    ...
                    {type == "all" && (
                      <div
                        style={{ backgroundColor: "skyblue", padding: "0px 3px", borderRadius: "3px", float: "left" }}>
                        {user.type}
                      </div>
                    )}
                    <br />
